...
const BINARIES: &[(&str, &str)] = &[
    ...
    ("gear-v0.3.0-x86_64-unknown-linux-gnu", "tar.xz"),
    ("gear-v0.3.0-aarch64-apple-darwin", "tar.xz"),
    ("gear-v0.3.0-x86_64-apple-darwin", "tar.xz"),
    ("gear-v0.3.0-x86_64-pc-windows-msvc", "zip"),
